...
class ENC_ConvLSTM(Module):
    ...
    def __init__(self, device, channels_in, hidden_dim, kernel_size, channels_out=None, pass_states = False, return_sequence = False):
        ...
        self.forget =  Conv2d(channels_in+hidden_dim, hidden_dim, kernel_size, padding='same') #Linear(channels_in+hidden_dim,hidden_dim) #Conv2d(channels_in+hidden_dim, hidden_dim,  kernel_size, padding='same') 
        self.input = Conv2d(channels_in+hidden_dim, hidden_dim, kernel_size, padding='same') #Linear(channels_in+hidden_dim,hidden_dim) #HiddenBlock(channels_in, hidden_dim,  kernel_size)#
...
class DEC_ConvLSTM(Module):
    ...
    def __init__(self, device, channels_in, hidden_dim, kernel_size, channels_out=None, pass_states = False, return_sequence = False):
        ...
        #here we could use "HiddenBlock"
        self.forget = Linear(channels_in+hidden_dim,hidden_dim) #Conv2d(channels_in+hidden_dim, hidden_dim,  kernel_size, padding='same') #Conv2d(channels_in+hidden_dim, hidden_dim,  kernel_size, padding='same') 
        self.input = Linear(channels_in+hidden_dim,hidden_dim) #HiddenBlock(channels_in, hidden_dim,  kernel_size)#
        self.candidate = Linear(channels_in+hidden_dim,hidden_dim) # HiddenBlock(channels_in, hidden_dim,  kernel_size) #
        self.output =  Linear(channels_in+hidden_dim,hidden_dim) #Conv2d(channels_in+hidden_dim, hidden_dim, kernel_size, padding='same') # HiddenBlock(channels_in, hidden_dim,  kernel_size)
